\documentclass[paper=a4, fontsize=11pt, BCOR=13mm, DIV=13, headinclude, toc=index, toc=bibliography, british, twoside]{scrreprt}
...
\usepackage[backend=biber, style=alphabetic, language=british]{biblatex}  % Gute Erweiterung zu bibtex, Wird für Referenzen benutzt.
...
\setcounter{page}{3}    % Die Titelseite und die darauffolgende leere Seite sollen Seite 1 und 2 sein.
\tableofcontents        % Inhaltsverzeichnis ausgeben

%mathematics of CW-complexes
\cleardoublepage 
\input{chapter_mathematics/chapter_mathematics.tex}
\input{chapter_lee/chapter_lee.tex}
\input{chapter_inwardPointing/chapter_inwardPointing.tex}
